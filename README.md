<div align="center">
  ...
  <img src="https://github.com/S-Mohsen-H/E-KeyGen/blob/main/img/logo_alt.png?raw=true" alt="logo"/>
    
  ![Version](https://img.shields.io/badge/version-1.5.5.8-gold)
  
  [![Commit activity](https://img.shields.io/github/commit-activity/t/S-Mohsen-H/E-KeyGen/main?cacheSeconds=0)](https://github.com/S-Mohsen-H/E-KeyGen/commits/main)
  ![Last commit](https://img.shields.io/github/last-commit/S-Mohsen-H/E-KeyGen/main?cacheSeconds=0)
  ![Last test](https://img.shields.io/badge/last_test-14.08.2025_15:47_UTC+3-blue)
  [![Opened issues](https://img.shields.io/github/issues/S-Mohsen-H/E-KeyGen?color=darkred)](https://github.com/S-Mohsen-H/E-KeyGen/issues?cacheSeconds=0)
  [![Closed issues](https://img.shields.io/github/issues-closed/S-Mohsen-H/E-KeyGen?color=darkgreen&cacheSeconds=0)](https://github.com/S-Mohsen-H/E-KeyGen/issues?q=is%3Aissue+is%3Aclosed)
  ![License](https://img.shields.io/github/license/S-Mohsen-H/E-KeyGen)

# E-KeyGen
E-KeyGen - Trial-Key & Account generator for ESET Products
...
---
## 💰 Donations 💰
You can support this project financially by following the link [here](https://github.com/S-Mohsen-H/E-KeyGen?tab=readme-ov-file#-donations--1) 

---

## Useful links
My [public channel with archives of my projects](https://t.me/S-Mohsen-H_official)
...
ESET -> Settings -> Advanced Setup -> Detection Engine -> Exclusions -> Detection Exclusions -> add ```full path to E-KeyGen-main folder```
...
You can simply use the GitHub actions workflow given [here](https://github.com/S-Mohsen-H/E-KeyGen/blob/main/.github/workflows/eset.yml) in your GitHub repo.
...
4. If an **ACT0** or **ACT5** error occurs during activation, check whether the ESET HOME account is connected. If so, disconnect it and try again.
   If the error persists, try activating with [Account Generator](https://github.com/S-Mohsen-H/E-KeyGen/blob/main/wiki/AccountGenerator.md).
